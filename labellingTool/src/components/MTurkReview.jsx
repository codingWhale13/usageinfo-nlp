...
const REVIEW = process.env.NODE_ENV === 'production' ? {} : 
    {
...
<Review 
                review={{...this.state.review, label: {annotations: this.state.annotations, customUsageOptions: this.state.customUsageOptions, replacementClasses: new Map()}}}
