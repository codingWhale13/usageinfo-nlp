            ...
            <AlertDialogContent>
              ...
              <AlertDialogBody>
                <Stack spacing={4} pl="2">
                  <Text>
                    The goal of this project is to <Text as="b">evaluate extracted usage options</Text> from
                    Amazon product reviews. For every review, your job is to
                    evaluate every usage option that was labelled in the review. Your evaluation consists of two steps:
                    </Text>
                    <UnorderedList stylePosition={'inside'}>
                      ...
                      <ListItem>
                        <Text as="b">Down- or Upvote</Text> wether usage options that are mentioned in the review are missing
                      </ListItem>
                    </UnorderedList> 
                  ...
                  <Text>
                    ...
                    <UnorderedList stylePosition={'inside'}>
                      ...
                      <ListItem>
                        "You can <Text as="b">chop wood</Text> and <Text as="b">break concrete</Text>  with it."
                      </ListItem>
                      <ListItem>
